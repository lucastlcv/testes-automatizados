...
context('Teste SLA', () => {
    it.only('Configuração SLA', () => {
        ...
        cy.get(':nth-child(5) > .bg-white > :nth-child(1) > :nth-child(1) > .card-milvus > .card-header-milvus > .col-5 > .btn').click({force:true}).wait(500)
        ...
        cy.get(':nth-child(5) > .bg-white > :nth-child(1) > :nth-child(1) > .card-milvus > .card-header-milvus > .col-5 > .btn').click({force:true})
        cy.get('#button-basic').click({force:true})
